...
public function createOrder(Request $request)
{
    ...
    // === Generate QR Code ===
    $url = "http://v2.deltho.info/api/printOrder/" . $orderId . "/web";
...
public function printOrder(Request $request, $id, $orderItem = null)
{
    ...
    $order = Order::where('order_id', $currentOrderId)->first();
        ...
        // Generate QR Code
        $url = "http://v2.deltho.info/api/printOrder/" . $currentOrderId . "/web";
        $qrCode = Builder::create()
            ->writer(new PngWriter())
            ->data($url)
            ->size(300)
...
//     $url = "http://v2.deltho.info/api/printOrder/" . $currentOrderId;
//     $qrCode = Builder::create()
//         ->writer(new PngWriter())
//         ->data($url)
//         ->size(300)
